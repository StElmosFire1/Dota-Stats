...
import {
  ...
  Search, Bell, ListVideo, AlignLeft,
...
export function HybridCourtPitch() {
  ...
  return (
    <div className={`hybrid-court-pitch min-h-screen flex flex-col ${themeClass}`}>
      {/* Broadcast Ticker */}
      <div
        className="h-7 flex items-center overflow-hidden uppercase font-condensed font-medium text-sm tracking-wider"
        style={{ backgroundColor: 'var(--ticker-bg)', color: 'var(--ticker-text)' }}
      >
      ...
      <header
        ...
        style={{ borderColor: 'var(--border-subtle)', backgroundColor: 'var(--bg-header)', backdropFilter: 'blur(8px)' }}
      >
        <div className="max-w-[1280px] mx-auto h-16 px-6 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <div className="h-8 hairline-vertical hidden md:block" />

            <nav
              className="hidden md:flex items-center gap-6 font-condensed font-medium tracking-wide text-sm"
              style={{ color: 'var(--text-muted)' }}
            >
              <a href="#" className="transition-colors" style={{ color: 'var(--text-main)' }}>HOME</a>
              <a href="#" className="transition-colors hover:text-opacity-80">MATCHES</a>
              <a href="#" className="transition-colors hover:text-opacity-80">LEADERBOARD</a>
              <a href="#" className="transition-colors hover:text-opacity-80">HEROES</a>
          ...
          <div className="flex items-center gap-3">
            ...
            <div
              className="hidden lg:flex items-center gap-2 text-xs font-condensed tracking-wider border px-3 py-1.5 rounded-md cursor-pointer"
              style={{ borderColor: 'var(--border-subtle)', color: 'var(--text-muted)' }}
            >
            ...
            <div
              className="flex items-center gap-3 border pl-1.5 pr-4 py-1 rounded-md"
              style={{ borderColor: 'var(--border-subtle)', backgroundColor: 'var(--bg-card)' }}
            >
              <img
                src="https://api.dicebear.com/9.x/identicon/svg?seed=cookie&backgroundColor=1f315a"
                alt="Avatar"
      ...
      <main className="max-w-[1280px] w-full mx-auto px-6 py-10 space-y-12 flex-1">
        ...
        {/* Hero */}
        <section className="oa-card oa-hero-glow relative p-12 overflow-hidden flex flex-col justify-center min-h-[380px]">
          <div className="absolute right-0 bottom-0 opacity-[0.06] pointer-events-none translate-x-1/4 translate-y-1/4">
            <img src="/__mockup/images/oa-logo.png" alt="" className="w-[520px] h-auto" />
          </div>

          <div className="relative z-10 max-w-3xl">
            <div
              className="inline-flex items-center gap-2 border rounded-full px-3 py-1 mb-6 font-condensed font-medium uppercase tracking-widest text-xs"
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <Button className="oa-cta-primary font-condensed font-medium text-lg uppercase tracking-wider px-8 py-6 h-auto">
                Join the league
              </Button>
              <Button className="oa-cta-ghost font-condensed font-medium text-lg uppercase tracking-wider px-8 py-6 h-auto">
                View Leaderboard
              </Button>
            </div>
          </div>
        ...
        {/* Stats Strip */}
        <div
          className="grid grid-cols-2 md:grid-cols-4 gap-px overflow-hidden rounded-lg border"
            ...
            <div>
              <div className="flex items-end justify-between mb-2">
                <div>
                  ...
                  <p className="font-serif italic text-sm mt-0.5" style={{ color: 'var(--text-muted)' }}>From the past 48 hours</p>
                </div>
                <a
                  href="#"
                  className="font-condensed font-medium text-sm uppercase tracking-wider flex items-center gap-1 transition-colors hover:opacity-80"
                  style={{ color: 'var(--accent-brass)' }}
                >
                  View all <ExternalLink className="w-3 h-3" />
                </a>
              </div>
              <div className="oa-rule-double mb-5" />

              <div className="oa-card flex flex-col">
                <div
                  className="flex border-b font-condensed font-medium uppercase tracking-widest text-xs px-5 py-3"
                  style={{ borderColor: 'var(--border-subtle)', color: 'var(--text-muted)', backgroundColor: 'var(--bg-base)' }}
                >
                  <div className="w-28">Winner</div>
                  <div className="flex-1">Score</div>
                  <div className="w-24 text-center">Duration</div>
                  <div className="w-28 text-center">MVP</div>
                ...
                {[
                  ...
                  <div
                    key={m.id}
                    className="flex items-center px-5 py-4 border-b last:border-0 transition-colors"
                    style={{ borderColor: 'var(--border-subtle)' }}
                  >
                    <div className="w-28">
                      <span className={`oa-tag ${m.r ? 'oa-tag-radiant' : 'oa-tag-dire'}`}>
                        {m.r ? 'Radiant' : 'Dire'}
                      </span>
                    </div>
                    ...
                    <div className="w-28 text-center font-serif font-bold italic" style={{ color: 'var(--accent-brass)' }}>{m.m}</div>
                    <div className="w-20 text-right font-condensed text-sm tracking-wide" style={{ color: 'var(--text-muted)' }}>{m.t}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flex items-end justify-between mb-2">
                <div>
                  ...
                  <p className="font-serif italic text-sm mt-0.5" style={{ color: 'var(--text-muted)' }}>Workspace preview</p>
                </div>
              </div>
              <div className="oa-rule-double mb-5" />

              <div
                className="oa-card flex h-[550px]"
                ...
                >
                  <div className="p-4 border-b" style={{ borderColor: 'var(--border-subtle)' }}>
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        placeholder="Search..."
                        className="w-full border rounded-md py-1.5 pl-9 pr-3 text-sm focus:outline-none transition-colors"
                  ...
                  <div className="flex-1 overflow-y-auto py-4 space-y-6">
                    <div className="px-3">
                      ...
                      <div className="flex items-center gap-3 px-3 py-1.5 rounded-md text-sm cursor-pointer" style={{ color: 'var(--text-muted)' }}>
                    ...
                    <div className="px-3">
                      ...
                      <div
                        className="relative flex items-center gap-3 px-3 py-1.5 rounded-md text-sm cursor-pointer font-medium"
                        style={{ backgroundColor: 'color-mix(in srgb, var(--accent-brass) 18%, transparent)', color: 'var(--text-main)' }}
                      >
                        <span className="absolute left-0 top-1.5 bottom-1.5 w-[3px] rounded-full" style={{ backgroundColor: 'var(--accent-brass)' }} />
                        <AlignLeft className="w-4 h-4" style={{ color: 'var(--accent-brass)' }} /> <span>Welcome Modal</span>
                      </div>
                      <div className="flex items-center gap-3 px-3 py-1.5 rounded-md text-sm cursor-pointer" style={{ color: 'var(--text-muted)' }}>
                  ...
                  <div className="max-w-2xl mx-auto space-y-8">
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            type="text"
                            defaultValue="v5.60"
                            className="w-full border rounded-md px-3 py-2 text-sm focus:outline-none font-condensed tracking-wide"
                            style={{ backgroundColor: 'var(--input-bg)', borderColor: 'var(--border-subtle)', color: 'var(--accent-brass)' }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          type="text"
                          defaultValue="Season 10 is here"
                          className="w-full border rounded-md px-3 py-2 text-sm font-serif font-bold focus:outline-none"
                          style={{ backgroundColor: 'var(--input-bg)', borderColor: 'var(--border-subtle)', color: 'var(--text-main)' }}
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          className="w-full border rounded-md px-3 py-2 text-sm focus:outline-none resize-none font-serif italic"
                          style={{ backgroundColor: 'var(--input-bg)', borderColor: 'var(--border-subtle)', color: 'var(--text-main)' }}
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            type="text"
                            defaultValue="/patch-notes"
                            className="w-full border rounded-md px-3 py-2 text-sm focus:outline-none font-condensed"
                            style={{ backgroundColor: 'var(--input-bg)', borderColor: 'var(--border-subtle)', color: 'var(--text-muted)' }}
                          />
                        </div>
                      </div>

                      <div className="flex justify-end pt-4">
                        <Button className="oa-cta-primary font-condensed font-medium text-base uppercase tracking-wider px-6 py-5">
                          Save Changes
                        </Button>
                      </div>
                    </div>
            ...
            <div>
              <div className="flex items-end justify-between mb-2">
                <div>
                  ...
                  <p className="font-serif italic text-sm mt-0.5" style={{ color: 'var(--text-muted)' }}>Season 10 standings</p>
                </div>
                <span
                  className="font-condensed font-medium text-xs uppercase tracking-widest border rounded-full px-2.5 py-0.5"
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={p.rank}
                    className="oa-card oa-card-rule flex items-center pl-5 pr-4 py-3 transition-colors"
                  >
                    <div className={`oa-rank-numeral w-10 text-center mr-4 ${p.rank <= 3 ? 'is-top' : ''}`}>
                      {p.rank}
                    </div>
              ...
              <Button className="oa-cta-ghost w-full mt-4 font-condensed font-medium text-sm uppercase tracking-widest">
                Full Leaderboard
              </Button>
            </div>

            {/* Editor's Pick */}
            <div className="oa-card oa-card-rule p-6 relative">
              ...
              <a
                href="#"
                className="font-condensed font-medium text-xs uppercase tracking-wider flex items-center gap-1 hover:underline"
