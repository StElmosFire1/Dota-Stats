// Task #852 — mirror of the full edition's tests/agentClassifier.test.js:
// the community edition's AI-agent classifier records/blocks traffic but
// never DMs the owner (DM digests were removed in Task #850).
...
test('AI crawler is recorded but no owner DM fires (community edition)', async () => {
  _resetForTests();
