    ...
    mmrRoles: {
      ...
      tiers: [
        ...
        },
        {
          name: 'Peasant',
          emoji: '🌾',
          description: 'Tilling the fields. Tomorrow may bring the call to arms.',
          min: 1100,
        ...
        },
        {
          name: 'Vagabond',
          emoji: '🥾',
          description: 'Wandering the realm. No banner, no oath, no glory yet.',
          min: 800,
        ...
        },
        {
          name: 'Outlaw',
          emoji: '🏴',
          description: 'Branded and exiled. The kingdom does not speak your name.',
          min: 600,
