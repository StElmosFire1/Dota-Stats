...
description: Why oceinhouse.gg's Let's Encrypt cert expired and how it's renewed now
---
...
- Nothing monitors cert expiry between deploys — the Task #895 public-health deploy gate only fires on deploy.
