...
echo "[post-merge] Verifying each admin tab has exactly one render guard (Task #758)..."
# Hard gate: refuse to push if any TAB_META tab id in web/src/pages/AdminPanel.jsx
